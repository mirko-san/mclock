...
export class MClock extends LitElement {
  ...
  render() {
    return html`
      <div class="m-container">
        <div
          class="inline-block m-8 px-6 pt-4 pb-6 bg-[${this
            ._BgColorStr}] rounded tracking-widest"
        >
  ...
  willUpdate() {
    const _bgColor = colord(this.bgColor).alpha(
      Number.parseFloat(this.bgOpacity),
    );
